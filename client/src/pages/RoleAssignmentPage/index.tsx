      ...
      <div className="m-8 grid justify-items-center">
        <div className="my-8">
          <Typography variant="h5" className="pb-4">
            Each debate room can have 1 moderator and 2 debators
          </Typography>
          <Typography>
            {/* Number of Moderators in the room: {numOfModerators} */}
            Number of Moderators in the room: {0}
          </Typography>
          <Typography>
            {/* Number of Debators in the room: {numOfDebators} */}
            Number of Debators in the room: {0}
          </Typography>
        </div>
        ...
        <Button
          ...
          onClick={() => onEnterRoomButtonClicked()}
        >
          Enter Debate Room
        </Button>
      </div>
